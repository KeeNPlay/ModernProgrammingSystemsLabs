    ...
    return (
        <SafeAreaView style={styles.container}>
                <View style={styles.skipContainer}>
                    <TouchableWithoutFeedback style={styles.skipBtn} onPress={() => {
                ...
                <View>
                    <Pagination carouselRef={_carousel} activeDotIndex={activeDotIndex} dotsLength={3}
                                dotStyle={{width: 15}} inactiveDotStyle={{width: 5}}/>
                </View>
